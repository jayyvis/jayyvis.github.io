...
I'm a hands on platform engineer:
...
- Preview (Ephemeral) environments for dev testing
- Modernized CI/CD pipelines for micro services
- Trunk Based Development, Continuous Integration, Continuous Deployment
- Executed Cloud Migrations, Cloud Bursting for big data, and AI/ML workloads
...
- [Cloudpickle](https://cloud.pickleio.com) : Hybrid cloud self service portal for developers to quickly spin up dev boxes

<h3 id="startup">Launched for Clients</h3>
